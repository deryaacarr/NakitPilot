...
export const DASHBOARD_NAV: NavItem[] = [
  ...
  { href: "/collections/field", label: "Saha", icon: "collections" },
  { href: "/promises", label: "Ödeme sözleri", icon: "collections" },
  { href: "/legal", label: "Hukuki", icon: "reports" },
  { href: "/legal/portal", label: "Avukat portalı", icon: "developers" },
  ...
  { href: "/dashboard/design-system", label: "Tasarım", icon: "settings" },
